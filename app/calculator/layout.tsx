...
export const metadata: Metadata = {
  title: "복지 수령액 계산기 — 실업급여·기초연금·근로장려금·자녀장려금·건강보험료",
  description:
    "실업급여, 기초연금, 부모급여, 근로장려금, 자녀장려금, 국민연금, 건강보험료를 간단히 계산해보세요. 내 조건을 입력하면 예상 수령액을 바로 확인할 수 있습니다.",
  keywords: [
    "실업급여 계산기", "기초연금 계산기", "근로장려금 계산기", "자녀장려금 계산기",
