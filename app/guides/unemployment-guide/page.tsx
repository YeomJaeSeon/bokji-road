...
export const metadata: Metadata = {
  title: "실업급여 하루 최대 66,000원 — 2026 자격조건·수령액 계산·신청방법",
  description:
    "2026년 실업급여 신청 방법 완벽 안내. 하루 최대 66,000원·최대 270일 수령 가능. 자격 조건 확인부터 고용센터 신청, 실업 인정 신청까지 단계별로 정리했습니다. 자발적 퇴직도 일부 해당.",
  keywords: [
    "실업급여 신청 방법", "실업급여 자격", "실업급여 수령액", "구직급여 신청",
    "실업급여 계산", "자발적 퇴직 실업급여", "고용보험 실업급여", "2026 실업급여",
  ],
  alternates: { canonical: "https://bokji-road.vercel.app/guides/unemployment-guide" },
  openGraph: {
    title: "실업급여 신청 완벽 가이드 2026 | 복지로드",
    description: "자격 조건·수령액 계산·신청 단계를 한 번에 확인하세요.",
    type: "article",
    locale: "ko_KR",
    url: "https://bokji-road.vercel.app/guides/unemployment-guide",
    siteName: "복지로드",
  },
};
