...
const GUIDES = [
  ...
  {
    href: "/guides/long-term-care",
    icon: "🏥",
    color: "bg-sky-50 border-sky-200",
    tag: "노인장기요양",
    tagColor: "bg-sky-100 text-sky-700",
    title: "노인장기요양등급 신청 방법 2026 — 1~5등급 판정 기준·혜택",
    desc: "방문요양·주간보호·요양원 비용 80~100% 국가 지원. 등급 판정 기준, 재가·시설급여 차이, 신청 절차 총정리.",
    readTime: "약 6분",
  },
  {
    href: "/guides/youth-rent-support",
    icon: "🏠",
    color: "bg-lime-50 border-lime-200",
    tag: "청년 주거",
    tagColor: "bg-lime-100 text-lime-700",
    title: "청년 월세 지원 신청 방법 2026 — 월 최대 20만원",
    desc: "만 19~34세 1인 가구 소득 중위 60% 이하라면 월 최대 20만원, 최대 12개월 월세 지원. 주거급여 분리지급도 포함.",
    readTime: "약 5분",
  },
  {
    href: "/guides/medical-benefit",
    icon: "💊",
    color: "bg-blue-50 border-blue-200",
    tag: "의료급여",
    tagColor: "bg-blue-100 text-blue-700",
    title: "의료급여 1종·2종 차이 완벽 정리 2026",
    desc: "의료급여 1종이면 입원비 무료·외래 1,000원. 1종·2종 자격 차이, 본인부담금, 신청 방법 한 번에.",
    readTime: "약 5분",
  },
  {
    href: "/guides/education-benefit",
    icon: "✏️",
    color: "bg-violet-50 border-violet-200",
    tag: "교육급여",
    tagColor: "bg-violet-100 text-violet-700",
    title: "교육급여 신청 방법 2026 — 초중고 최대 768,000원",
    desc: "기준 중위소득 50% 이하 가정 초·중·고 학생 연간 최대 768,000원. 자동 지급 없음, 매년 3월 반드시 신청.",
    readTime: "약 4분",
  },
  {
    href: "/guides/developmental-disability",
    icon: "🧩",
    color: "bg-purple-50 border-purple-200",
    tag: "발달장애",
    tagColor: "bg-purple-100 text-purple-700",
    title: "발달장애인 지원 완벽 가이드 2026 — 바우처·활동지원",
    desc: "지적·자폐 장애 아동·성인을 위한 발달재활 바우처, 활동지원서비스, 주간활동, 평생교육 지원 총정리.",
    readTime: "약 5분",
  },
  {
    href: "/guides/subway-free-ride",
    icon: "🚇",
    color: "bg-cyan-50 border-cyan-200",
    tag: "교통복지",
    tagColor: "bg-cyan-100 text-cyan-700",
    title: "지하철 무임승차 자격 및 신청 방법 2026",
    desc: "만 65세 이상·장애인·국가유공자 무임승차 자격과 복지카드 발급 절차 한 번에. 신청 안 하면 못 받습니다.",
    readTime: "약 4분",
  },
  {
    href: "/guides/elderly-alone-support",
    icon: "🏠",
    color: "bg-emerald-50 border-emerald-200",
    tag: "독거노인",
    tagColor: "bg-emerald-100 text-emerald-700",
    title: "독거노인 지원 신청 방법 완벽 가이드 2026",
    desc: "혼자 사는 어르신을 위한 돌봄서비스·응급안전안심서비스·무료 도시락 배달·주거개선 지원 총정리.",
    readTime: "약 5분",
  },
  {
    href: "/guides/multi-child-benefits",
    icon: "👨‍👩‍👧‍👦",
    color: "bg-pink-50 border-pink-200",
    tag: "다자녀",
    tagColor: "bg-pink-100 text-pink-700",
    title: "다자녀 혜택 완벽 가이드 2026 — 두자녀·세자녀",
    desc: "다자녀우대카드·전기가스 요금 할인·자동차 취득세 면제·국가장학금·공공임대 우선 배정 총정리.",
    readTime: "약 6분",
  },
  {
    href: "/guides/prenatal-supplements",
    icon: "🌿",
    color: "bg-green-50 border-green-200",
    tag: "임신·출산",
    tagColor: "bg-green-100 text-green-700",
    title: "임산부 무료 엽산제·철분제 신청 방법 2026",
    desc: "임신 확인 후 보건소에서 엽산제 3개월분·철분제 5개월분 무료 수령. 신청 시기와 복용법 안내.",
    readTime: "약 4분",
  },
  {
    ...
    tag: "에너지바우처",
    tagColor: "bg-orange-100 text-orange-700",
    title: "에너지바우처 신청 방법 2026 — 난방비·냉방비 지원",
    desc: "기초수급·차상위계층 중 노인·장애인·영유아 포함 가구라면 동절기 최대 254,500원 난방비 지원.",
    readTime: "약 5분",
  },
  {
    href: "/guides/near-poverty-line",
    icon: "🤝",
    color: "bg-teal-50 border-teal-200",
    tag: "차상위계층",
    tagColor: "bg-teal-100 text-teal-700",
    title: "차상위계층 확인 신청 방법 완벽 가이드 2026",
    desc: "중위소득 50% 이하라면 의료비·통신비·전기료 감면 등 연간 40만원 이상 절약. 신청 방법 총정리.",
    readTime: "약 5분",
  },
  {
    href: "/guides/parental-leave-pay",
    icon: "👨‍👩‍👧",
    color: "bg-pink-50 border-pink-200",
    tag: "육아·출산",
    tagColor: "bg-pink-100 text-pink-700",
    title: "육아휴직급여 신청 방법 완벽 가이드 2026",
    desc: "3+3 육아휴직제로 부모 모두 쓰면 첫 3개월 각 최대 300만원. 출산전후휴가 급여까지 총정리.",
    readTime: "약 5분",
  },
  {
    href: "/guides/national-pension-guide",
    icon: "🏦",
    color: "bg-indigo-50 border-indigo-200",
    tag: "국민연금",
    tagColor: "bg-indigo-100 text-indigo-700",
    title: "국민연금 완벽 가이드 2026 — 예상수령액·조기수령·연기·추납",
    desc: "언제 받느냐에 따라 수령액이 최대 36% 달라집니다. 예상수령액 확인부터 추납까지 한 번에.",
    readTime: "약 6분",
  },
  {
    href: "/guides/senior-jobs",
    icon: "💪",
    color: "bg-emerald-50 border-emerald-200",
    tag: "노인 일자리",
    tagColor: "bg-emerald-100 text-emerald-700",
    title: "노인 일자리 신청 방법 완벽 가이드 2026",
    desc: "공익활동 월 27만원, 사회서비스형 월 59만원, 시장형 83만원+. 유형별 급여·자격·신청기간 총정리.",
    readTime: "약 5분",
  },
  {
    href: "/guides/disability-pension",
    icon: "♿",
    color: "bg-purple-50 border-purple-200",
    tag: "장애인연금",
    tagColor: "bg-purple-100 text-purple-700",
    title: "장애인연금 신청 방법 완벽 가이드 2026",
    desc: "중증장애인(1·2급·3급 중복)이라면 기초급여 최대 월 333,800원 + 부가급여 최대 90,000원.",
    readTime: "약 5분",
  },
  {
