...
export const metadata: Metadata = {
  title: "기초연금 월 최대 334,810원 — 만 65세 신청자격·소득기준·신청방법 2026",
  description:
    "2026년 기초연금 수급자격 완벽 안내. 만 65세 이상 소득하위 70%라면 월 최대 334,810원 수령 가능. 소득인정액 계산법, 국민연금 감액 기준, 신청 서류까지 한 번에 확인하세요.",
  keywords: [
