...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${SITE_URL}/guides/single-parent`,
      lastModified: new Date("2026-06-01"),
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    {
      url: `${SITE_URL}/guides/disability-benefits`,
      lastModified: new Date("2026-06-01"),
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    {
      url: `${SITE_URL}/guides/welfare-glossary`,
      lastModified: new Date("2026-06-01"),
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/guides/regional-benefits`,
      lastModified: new Date("2026-06-01"),
      changeFrequency: "monthly" as const,
      priority: 0.85,
    },
    ...
    {
      url: `${SITE_URL}/guides/long-term-care`,
      lastModified: new Date("2026-06-13"),
      changeFrequency: "monthly" as const,
      priority: 0.95,
    },
    {
      url: `${SITE_URL}/guides/youth-rent-support`,
      lastModified: new Date("2026-06-13"),
      changeFrequency: "monthly" as const,
      priority: 0.95,
    },
    {
      url: `${SITE_URL}/guides/medical-benefit`,
      lastModified: new Date("2026-06-13"),
      changeFrequency: "monthly" as const,
      priority: 0.95,
    },
    {
      url: `${SITE_URL}/guides/education-benefit`,
      lastModified: new Date("2026-06-13"),
      changeFrequency: "monthly" as const,
      priority: 0.95,
    },
    {
      url: `${SITE_URL}/guides/developmental-disability`,
      lastModified: new Date("2026-06-13"),
      changeFrequency: "monthly" as const,
      priority: 0.95,
    },
